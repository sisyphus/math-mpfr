...
=head1 FUNCTIONS
   ...
   $ui = fpif_size($op);
    A calculation of the minimum size of the string buffer needed
    as 1st arg to Rmpfr_fpif_export_mem() above. The returned
    value should always be large enough, if not always the minimum.
