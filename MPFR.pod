...
=head1 FUNCTIONS
   ...
   $str = mpfrtoa($op [, $uv]); # $uv is optional but discouraged !!!
    ...
    *minimum* number of digits such that the condition ($str == $op)
    ...
    arcanely) in Math:FakeDD, and the option will be removed as soon
    as soon as Math::FakeDD can adapt to that removal.
