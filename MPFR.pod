...
=head1 PASSING _Decimal64 VALUES
   ...
   3.1.1 or later) with the --enable-decimal-float option, and
...
=head1 FUNCTIONS
   ...
   $si = Rmpfr_set_DECIMAL64($rop, $D64, $rnd) # mpfr-3.1.1 or later &&
                                               # mpfr lib built with
   ...
   Rmpfr_get_DECIMAL64($d64, $op, $rnd); # mpfr-3.1.1 or later &&
                                         # mpfr lib built with
                                         # --enable-decimal-float
                                         # && D64=1 arg given to
                                         # Makefile.PL. $D64 is a
