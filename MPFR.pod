...
=head1 FUNCTIONS
    ...
    *minimum* number of digits such that the condition ($str == $op)
    is true.
    A second (optional) arg that became available with Math-MPFR-4.24
    has been removed in Math-MPFR-4.33 because I don't think it ever
    served a useful purpose. It will be returned if requested, or if
    I ever understand that it did, in fact, serve some useful purpose.
    (I doubt that anyone was using it ... but let's see ... ;-)
