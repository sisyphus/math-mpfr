...
cmp_ok($Math::MPFR::VERSION, 'eq', '4.42', "Math::MPFR::VERSION ($Math::MPFR::VERSION) is as expected");

my $xs_version = Math::MPFR::_get_xs_version();
cmp_ok($xs_version, 'eq', '4.42', "Math::MPFR::_get_xs_version returns $xs_version as expected");
